// Edit this file to update the business name, contact details, and service
// area shown across the whole site. Nothing else needs to change.

export const site = {
  businessName: "Dennis Buys Vegas Houses",
  ...
  smsPrefillText:
    "Hi Dennis, I'd like an offer on my house. Address: ",
};
